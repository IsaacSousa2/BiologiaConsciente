        ...
        <div className="w-full bg-azul h-[440px] p-5 mt-5 items-center flex mm:h-[590px]">
            <div className="max-w-[1300px] mx-auto justify-center items-center">
                ...
                <div className="gap-4 flex flex-col">
                    <p className="text-white md:text-lg">Nós somos alunos de uma EEEP com o intuito de conscientizar as pessoas sobre um problema recorrente na sociedade: a falta de conhecimento em relação ao corpo e às relações íntimas. </p>
                    <p className="text-white md:text-lg">Tudo começou quando nosso professor de biologia nos atribuiu um trabalho relacionado ao tema, e nosso grupo teve a ideia de criar um site que reuniria diversas informações sobre o assunto. Nossa diretora de turma (DT), considerando a ideia boa, propôs nos inscrever na feira de ciências. </p>
                </div>
            </div>
        </div>
    )
